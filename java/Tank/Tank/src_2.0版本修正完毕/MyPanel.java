...
class StartPanel extends JPanel implements Runnable{
	...
	public void paint(Graphics g)
	{
		...
		if(times%2==0){//tips：这个可让下面的字体交替闪烁显示 主要利用奇数和偶数的变化
		g.setFont(new Font("华文新魏",Font.BOLD, 22));
		g.drawString("GameStart!!!", 300, 200);
		g.drawString("游戏开始!!!", 300, 230);
		}
	}
	public void run()
	{
...
//			Ehero.bullets.add(zd);		
	...
	{	
		...
		g.fill3DRect(0, 0, 1024, 600, false); //主银幕绘制
...
//////////////////////////////////////////////////////////////////////////
		...
		if(Recorder.gameFailed)//游戏失败
		{	g.setColor(Color.BLUE);
			g.setFont(new Font("华文新魏",Font.CENTER_BASELINE,33));
			g.drawString("GameOver!!!", 100, 100);
			g.drawString("得分概要", 100, 200);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	g.setColor(Color.ORANGE);	
	g.setFont(new Font("华文新魏",Font.BOLD,22));
	g.drawString("游戏状态", 840, 40);
	this.DrawTank(820,90,1,g,0);//画出自己坦克
	this.DrawTank(820,180,1,g,1);//画出敌人坦克
	g.setColor(Color.red);	
	g.drawString(Recorder.ts+"", 900, 120); //自己的生命值
	g.drawString(Recorder.ets+"", 900, 200);//敌人的剩余数量
	}
