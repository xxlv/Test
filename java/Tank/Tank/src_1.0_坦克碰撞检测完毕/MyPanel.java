...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void hitTest(MTank h){		
		...
		for(int i=0;i<h.bullets.size();i++)			
		{
			...
			//碰撞检测子弹
			if(mb.x<0||mb.x>950||mb.y<0||mb.y>400)
			{
				h.bullets.remove(mb);
		...
		for(int k=0;k<Eheros.size();k++)//遍历敌机
		{
			...
			for(int j=0;j<et.bullets.size();j++)
			{
				...
				if(eb.x<0||eb.x>600||eb.y<0||eb.y>400)
				{	
...
//			if(et.getDirect()==0||et.getDirect()==2)//坦克向上或者向下
//			{
//				if(et2.getDirect()==0||et2.getDirect()==2)//如果待检测坦克也是向上或者向下
//				{
//					if(Math.abs(et.getPositionY()-et2.getPositionY())<=40)//说明两个互相碰撞
//					{
//					
//						
//						et2.setDirect(et.getDirect());
//						et.setDirect(et2.getDirect());
//						
//						
//					}
//					
//					
//				}
//				else if(et2.getDirect()==1||et2.getDirect()==3)//待检测坦克向左或者向右
//				{
//					if(Math.abs(et.getPositionX()-et2.getPositionX())<=40)//说明两个互相碰撞
//					{
//						et2.setDirect(et.getDirect());
//						et.setDirect(et2.getDirect());
//						
...
//				
//			}
//			else if(et.getDirect()==1||et.getDirect()==3)//坦克朝左或者朝右
//			{
//				if(et2.getDirect()==1||et2.getDirect()==3)//待检测的坦克朝左侧或者右侧
//				{
//					if(Math.abs(et.getPositionX()-et2.getPositionX())<=40){
//						
//						et2.setDirect(et.getDirect());
//						et.setDirect(et2.getDirect());
//					}
//					
//				}
//				else if(et2.getDirect()==0||et2.getDirect()==2)//待检测坦克向上或下
//				{
//					if(Math.abs(et.getPositionX()-et2.getPositionX())<=40&&Math.abs(et.getPositionY()-et2.getPositionY())<=40){
//						
//						et2.setDirect(et.getDirect());
//						et.setDirect(et2.getDirect());
//					}
